...
import { index, integer, jsonb, pgEnum, pgTable, text, uniqueIndex, timestamp, varchar } from "drizzle-orm/pg-core";
...
export const enrollments = pgTable('enrollments', {
    ...
    uniqueIndex('enrollments_student_id_class_id_uq').on(table.studentId, table.classId),
